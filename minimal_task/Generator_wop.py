...
from arithmetic_experiments.minimal_task_experiment.utils import Config
from modular_data_generation_wop import generate_noisy_twosteps_dataset_modp, generate_noisy_twosteps_dataset_modp_wop, generate_noisy_twosteps_varied_dataset_modp
from arithmetic_experiments.minimal_task_experiment.Multiplication_addition_training_wop import decode_expressions
...
def _write_chunk_to_memmap(args):
    ...
    base_seed = 20250831 + seed_offset
    random.seed(base_seed)
    torch.manual_seed(base_seed)


    data, _, _ = generate_noisy_twosteps_dataset_modp_wop(N=chunk_size, p=modulus, p1=p1, p2=p2)
...
def build_and_save_memmap(
    ...
    first_size = sizes[0]
    data0, _, _ = generate_noisy_twosteps_dataset_modp_wop(N=first_size, p=modulus, p1=p1, p2=p2)
